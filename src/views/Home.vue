<template>
  <div>
    ...
    <iframe
      width="100%"
      height="315"
      src="https://www.youtube.com/embed/SU0sh-NxmME"
    ...
    <div class="flex flex-wrap">
      <div
        v-for="n in 10"
        :key="n"
        class="w-96 card m-4 rounded-4 min-w-sm border border-gray-700 bg-gray-700 text-gray-50   transition-shadow shadow-xl hover:shadow-xl min-w-max"
      >
        <div class="w-full card__media">
          <img
            src="http://via.placeholder.com/950x450/23689B?text=/\/\/\"
            class="h-48 w-96"
          />
        </div>
        ...
        <div class="flex items-center p-4">
          <div class="relative flex flex-col items-center w-full">
            ...
            <div
              class="flex flex-col space-y-1 justify-center items-center -mt-12 w-full"
            >
              ...
              <div class="py-2 flex space-x-2">
                <button
                  class="flex justify-center  max-h-max whitespace-nowrap focus:outline-none  focus:ring  focus:border-blue-300 rounded max-w-max border bg-transparent border-purple-400 text-purple-400 hover:border-purple-800 hover:border-purple-500 px-4 py-1 flex items-center hover:shadow-lg"
                >
                  <span class="mr-2"></span>FOLLOW<span
                    class="ml-2"
                  ></span></button
                ><button
